	Computer_System u0 (
		...
		.telemetre_us_dist          (<connected-to-telemetre_us_dist>),          //         telemetre_us.dist
		.telemetre_us_echo          (<connected-to-telemetre_us_echo>),          //                     .echo
		.telemetre_us_trig          (<connected-to-telemetre_us_trig>)           //                     .trig
	);
